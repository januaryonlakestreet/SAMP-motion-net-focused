...
public class SAMP_Demo_unguided : NeuralAnimation
{
    ...
    protected void Default()
    {
        ...
        {
            Signals[1] = sig;
            ApplyStaticGoal(target.transform.position, Vector3.ProjectOnPlane(target.transform.position - transform.position, Vector3.up).normalized, Signals);
